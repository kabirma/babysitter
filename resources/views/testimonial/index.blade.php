                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="container row">
                        ...
                        <div class="col-md-4 text-right">
                            <a href="{{ route('testimonialadd') }}" class="btn btn-sm btn-secondary" data-toggle="tooltip"
                                title="Add {{ $title }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->role == 'admin')
                                            <a href="{{ route('testimonialedit', $row->id) }}"
                                        ...
                                        @if (Auth::guard('admin')->user()->role == 'admin')
                                            <button type="button" class="btn btn-sm btn-secondary delete"
                                                data-title="{{ $row->name }} Testimonial"
                                                data-href="{{ route('testimonialdelete', $row->id) }}" data-toggle="modal"
