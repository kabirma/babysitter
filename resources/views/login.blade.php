    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-body-dark bg-pattern" style="background-image: url('{{asset('admin/assets/media/various/bg-pattern-inverse.png')}}');">
                    <div class="row mx-0 justify-content-center">
                        <div class="hero-static col-lg-6 col-xl-4">
                            <div class="content content-full overflow-hidden">
                                <!-- Header -->
                                <div class="py-30 text-center" style="margin-top:25%">
                                ...
                                <form action="{{route('submtlogin')}}" class="js-validation-signin"  method="post">
                                    @csrf
        ...
        <!--
            ...
            webpack is putting everything together at {{asset('admin/assets/_es6/main/app.js')}}
        -->
